...
public class Cases_time_series {
	...
	public String toString() {
		return "ClassPojo [date = " + date + ", dailyrecovered = " + dailyrecovered + ", dateymd = " + dateymd
				+ ", totalconfirmed = " + totalconfirmed + ", totaldeceased = " + totaldeceased + ", dailydeceased = "
				+ dailydeceased + ", totalrecovered = " + totalrecovered + ", dailyconfirmed = " + dailyconfirmed + "]";
	}
}
